...
var _themeHelpers = require("../utils/themeHelpers");
...
var createTheme = exports.createTheme = function createTheme() {
  ...
  var mergedTheme = _objectSpread(_objectSpread({}, _styling.defaultTheme), baseTheme);
  ...
  return _objectSpread(_objectSpread({}, mergedTheme), {}, {
    sizes: _styling.sizes,
    derivedBackground: (0, _themeHelpers.getDerivedColor)(background),
    primaryText: (0, _themeHelpers.getReadableTextColor)(primary),
    accentText: (0, _themeHelpers.getReadableTextColor)(accent),
    positiveText: (0, _themeHelpers.getReadableTextColor)(positive),
    negativeText: (0, _themeHelpers.getReadableTextColor)(negative),
    derivedSurface: (0, _themeHelpers.getDerivedColorPercentages)(surface),
    derivedSurfaceText: (0, _themeHelpers.getDerivedColorPercentages)(surfaceText)
  });
};
var ThemeProvider = exports.ThemeProvider = function ThemeProvider(_ref) {
  var children = _ref.children,
    providedTheme = _ref.theme;
  ...
  var contextValue = {
    ...
    setTheme: function setTheme(newTheme) {
      _setTheme(createTheme(newTheme));
    }
  };
